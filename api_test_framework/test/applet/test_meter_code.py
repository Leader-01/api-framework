...
class TestCode(unittest.TestCase):
    ...
    def setUp(cls):
        # 整个测试类只执行一次
        # 读取该测试类所有用例数据
        cls.data_list = excel_to_list("D:\PycharmProjects\mater_api\\api_test_framework\data\\test_water_data.xlsx", "Testwater")
...
#        params = {"tel": 18912345677, "address": "地址信息289"}
        ...
        # 日志写入
        log_case_info('test_water', url, data, expect_res, res.text)
        # 改为assertEqual断言
        # self.assertNotEqual(res.text, expect_res)
